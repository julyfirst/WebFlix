...
<%@include file="../includes/header.jsp" %>
            <div class="row">
                <div class="col-lg-12">
                	<form id="searchForm" action="/bb/list" method="get">
	              		<select name="type">
	              			<!-- 검색시 키워드 남아있게 -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">게시글목록페이지
                        ...
                        <div class="panel-body">
                             <table class="table table-striped table-bordered table-hover" >
	                                    ...
	                                    <tr>
	                                    	...
	                                    	<td>
	                                    		<a class="move" href='<c:out value="${board.bno}"/>'>
	                                    			<c:out value="${board.title}"></c:out> <b>[ <c:out value="${board.replyCnt}"/> ] </b>
	                                    		</a>
	                                    	</td>
                                ...
                                <div class="pull-right">
                                	...
                                	<form id="actionForm" action="/bb/list" method="get">
