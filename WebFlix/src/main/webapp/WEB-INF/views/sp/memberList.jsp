                             ...
                             <table class="table table-striped table-bordered table-hover" >
                                    ...
                                    <c:forEach items="${memberList}" var="member">
	                                    <tr>
	                                    	...
	                                    	<td><c:out value="${member.phonenumber}"></c:out></td>
	                                    	<td><c:out value="${member.birth_date}"></c:out></td>
	                                    	<td><fmt:formatDate pattern="yyyy-MM-dd" value="${member.regdate}"></fmt:formatDate></td>
	                                    	<td><fmt:formatDate pattern="yyyy-MM-dd" value="${member.updatedate}"></fmt:formatDate></td>
	                                    	<td><c:out value="${member.authList}"></c:out></td>
	                                    </tr>
                                    </c:forEach>
                                </table>
