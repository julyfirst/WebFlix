...
<div class="content2">
	<div class="cc">
		<img
			src="../../../resources/css/image/detail/action/killer_bodyguard/killermain.jpg"
			alt="">

		<div class="content3">
			<img
				src="../../../resources/css/image/detail/action/killer_bodyguard/mo3.jpg"
				alt="">
		</div>
	</div>

	<div class="content4">
		<form method="post" action="/pages/detail/action/killer_bodyguard">

			<input type="hidden" name="member_id"
				value='<sec:authentication property="principal.member.id"/>'
				readonly="readonly">

			<c:forEach var="killer" begin="2" end="2" items="${killer}">
				<input type="hidden" name="movie_id" value="${killer.movie_id}" />
				<input type="hidden" name="deal_price"
					value="${killer.movie_price2}" />
			</c:forEach>
...
<div class="content5">
	<h2>
		<c:forEach var="killer" begin="2" end="2" items="${killer}">
		    ${killer.movie_name}<p>The Hitman's Bodyguard</p>
		    가격 : ${killer.movie_price1 } -> 할인가     ${killer.movie_price2 }
	    </c:forEach>
	</h2>
</div>
</div>
...
<section>
	...
	<div class="mv-section4">
		...
		<ul class="mv1">
			<li class="mv2"><img
				src="../../../resources/css/image/detail/action/killer_bodyguard/kill1.jpg"
				alt=""></li>
			<li class="mv2"><img
				src="../../../resources/css/image/detail/action/killer_bodyguard/kill2.jpg"
				alt=""></li>
			<li class="mv2"><img
				src="../../../resources/css/image/detail/action/killer_bodyguard/kill3.jpg"
				alt=""></li>
			<li class="mv2"><img
				src="../../../resources/css/image/detail/action/killer_bodyguard/kill4.jpg"
				alt=""></li>
		</ul>
		<p class="pos">
	...
	<div class="mv-section6">
		<img
			src="../../../resources/css/image/detail/action/killer_bodyguard/actor3.png"
			alt="">
	</div>
	...
	<video class="mv-section8"
		src="../../../resources/css/mv_preview/kill.mp4" controls autoplay></video>
				 ...
				 e.preventDefault();
			 	 $.ajax({
					...
					success: function(data){
						window.location.href = "/download?fileName=killer_bodyguard.mp4";				 
					},
					error:function(){
						alert("실패");
					}
